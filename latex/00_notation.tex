...
\nomenclature[39]{DP}{dynamic programming}
\nomenclature[40]{RL}{reinforcement learning}
\nomenclature[41]{LQ}{linear quadratic}
\nomenclature[42]{ARE}{algebraic Riccati equation}
\nomenclature[43]{RDE}{Riccati differential equation}
\nomenclature[44]{DARE}{discrete algebraic Riccati equation}
\nomenclature[45]{GARE}{generalized (game) Riccati equation}
\nomenclature[46]{DGARE}{discrete generalized (game) algebraic Riccati equation}
\nomenclature[47]{DMD}{Dynamic Mode Decomposition}
\nomenclature[48]{DMDc}{Dynamic Mode Decomposition with Control}

\nomenclature[49]{LFR}{linear fractional representation}
\nomenclature[50]{LFT}{linear fractional transformation}
\nomenclature[51]{ULFT}{upper linear fractional transformation}
\nomenclature[52]{LLFT}{lower linear fractional transformation}

\nomenclature[53]{n.d.}{(of a matrix) negative definite}
\nomenclature[54]{n.n.d.}{(of a matrix) nonnegative definite}
\nomenclature[55]{p.d.}{(of a matrix) positive definite}

\nomenclature[56]{$\vb*{L}$}{loop transfer function; $\vb*{L}(z)$ in discrete time, $\vb*{L}(s)$ in continuous time}
\nomenclature[57]{$\vb*{S}$}{sensitivity function $\vb*{S} = [\vb*{I} + \vb*{L}]^{-1}$}
\nomenclature[58]{$\vb*{T}$}{complementary sensitivity function $\vb*{T} = \vb*{L}[\vb*{I} + \vb*{L}]^{-1}$}
